...
//  Sleepwalkers
//
//  Created by Victoria Corrodi on 7/4/17.
...
class MainViewController : UIViewController, MFMessageComposeViewControllerDelegate {
    ...
    @IBAction func settingButtonTapped(_ sender: UIButton) {
        performSegue(withIdentifier: "redoPreferences", sender: self)
    }
    ...
    @IBAction func mainButtonTapped(_ sender: UIButton) {
        ...
        if isGettingLocation {
            ...
            self.sleepModeLabel2.text = "Sleep Mode is On"
            ...
            self.sleepModeLabel2.textColor = lightGrayColor
            self.helpLabel.textColor = lightGrayColor
            self.settingButton.setBackgroundImage(#imageLiteral(resourceName: "LightGearImage.png"), for: .normal)
            self.infoButton.tintColor = lightGrayColor
